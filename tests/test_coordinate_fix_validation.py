...
def test_coordinate_consistency():
    ...
    try:
        ...
        print(
            f"   Style: left={initial_coords['styleLeft']}, top={initial_coords['styleTop']}"
        )
        ...
        print(
            f"   Style: left={during_drag_coords['styleLeft']}, top={during_drag_coords['styleTop']}"
        )
        ...
        print(
            f"   Style: left={final_coords['styleLeft']}, top={final_coords['styleTop']}"
        )
        ...
        print(
            f"   Style: left={after_esc_coords['styleLeft']}, top={after_esc_coords['styleTop']}"
        )
        ...
        print(
            f"   X coordinates: initial={initial_x}, during={during_x}, final={final_x}, after_esc={esc_x}"
        )
