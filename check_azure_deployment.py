...
def main():
    ...
    if api_healthy:
        ...
        if db_connected:
            ...
            print("\nApplication URLs:")
            print("- Admin: https://rfpo-admin.livelyforest-d06a98a0.eastus.azurecontainerapps.io")
            print("- User App: https://rfpo-user.livelyforest-d06a98a0.eastus.azurecontainerapps.io")
            print("- API: https://rfpo-api.livelyforest-d06a98a0.eastus.azurecontainerapps.io")
            print("\nDefault Login:")
